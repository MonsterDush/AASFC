...
class PhoneOtpChallenge(Base):
    ...
    verification_channel: Mapped[str] = mapped_column(String(16), nullable=False, default="SMS", index=True)
    external_check_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    external_target: Mapped[str | None] = mapped_column(String(64), nullable=True)
