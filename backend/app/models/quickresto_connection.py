...
class QuickRestoConnection(Base):
    ...
    kpi_product_mappings = relationship(
        "QuickRestoKpiProductMapping", back_populates="connection", cascade="all, delete-orphan"
    )
    ...
    import_batches = relationship(
        "QuickRestoImportBatch", back_populates="connection", cascade="all, delete-orphan"
    )
