...
PERMISSIONS: list[PermissionDef] = [
    ...
    PermissionDef(
        "POSITIONS_MANAGE", "Positions", "Управление должностями", "Создавать/редактировать/удалять должности"
    ),
    ...
    PermissionDef(
        ...
        "Назначать/менять должность сотруднику (в т.ч. приглашённому)",
    ),
    # Staff
    ...
    PermissionDef(
        "RECURRING_EXPENSES_VIEW", "Expenses", "Регулярные расходы: просмотр", "Видеть правила регулярных расходов"
    ),
    PermissionDef(
        "RECURRING_EXPENSES_MANAGE",
        "Expenses",
        "Регулярные расходы: управление",
        "Создавать и редактировать правила регулярных расходов и генерировать черновики",
    ),
    PermissionDef(
        "FINANCE_LEDGER_VIEW",
        "Expenses",
        "Финансовые движения",
        "Видеть журнал финансовых движений и переводы между типами оплат",
    ),
    PermissionDef(
        "PAYMENT_TRANSFERS_MANAGE",
        "Expenses",
        "Переводы между оплатами",
        "Создавать и редактировать переводы между типами оплат",
    ),
    # Reports
    ...
    PermissionDef(
        "SHIFT_REPORT_REOPEN",
        "Reports",
        "Закрытие смены: переоткрыть",
        "Переоткрывать закрытые отчёты (CLOSED -> DRAFT)",
    ),
    ...
    # Adjustments
    PermissionDef(
        "ADJUSTMENTS_VIEW", "Adjustments", "Просмотр штрафов/премий/списаний", "Видеть штрафы/премии/списания"
    ),
    PermissionDef(
        "ADJUSTMENTS_MANAGE",
        "Adjustments",
        "Управление штрафами/премиями/списаниями",
        "Создавать/редактировать штрафы/премии/списания",
    ),
    ...
    PermissionDef(
        "PAY_PROFILES_MANAGE",
        "Payroll",
        "Профили зарплаты: управление",
        "Создавать, редактировать и удалять профили зарплаты, компоненты и назначения",
    ),
    PermissionDef(
    ...
    PermissionDef(
        ...
        "Catalogs",
        "Архивирование способов оплат",
        "Архивировать/восстанавливать способы оплат",
    ),
