...
class DayEconomicsServiceTests(TestCase):
    def test_get_day_economics_builds_metrics_and_sections(self):
        with (
            patch(
                "app.services.finance.day_economics.get_day_finance_summary",
                return_value={
                    "date": date(2026, 3, 13),
            ...
            patch(
                "app.services.finance.day_economics._get_report_state",
                return_value={
                    "exists": True,
                    "report_id": 7,
                    "status": "CLOSED",
            ...
            patch(
                "app.services.finance.day_economics._get_team_snapshot",
                return_value={
                    "total_shift_count": 3,
                    "assignment_count": 5,
            ...
            patch(
                "app.services.finance.day_economics._group_revenue_breakdown",
                side_effect=[
                    [{"title": "Наличные", "code": "cash", "subtitle": None, "amount_minor": 60000}],
                    [
                        {"title": "Бар", "code": "bar", "subtitle": None, "amount_minor": 70000},
                        {"title": "Кухня", "code": "kitchen", "subtitle": None, "amount_minor": 30000},
                    ],
                ],
            ),
            patch(
                "app.services.finance.day_economics._get_kpi_breakdown",
                return_value=[{"metric_id": 1, "title": "Апселл", "code": "upsell", "unit": "QTY", "value_numeric": 7}],
            ),
            patch(
                "app.services.finance.day_economics.get_day_economics_plan",
                return_value={
                    "date": date(2026, 3, 13),
                    "source": "WEEKDAY_TEMPLATE",
                    "template_weekday": 4,
                    "template_weekday_title": "Пятница",
                    "revenue_plan_minor": 90000,
                    "profit_plan_minor": None,
                    "revenue_per_assigned_plan_minor": None,
                    "assigned_user_target": 4,
                    "notes": None,
                },
            ),
            patch(
                "app.services.finance.day_economics.get_venue_economics_rules",
                return_value={"warn_on_draft_expenses": True},
            ),
            patch(
                "app.services.finance.day_economics._build_rollup",
                return_value={
                    "month": "2026-03",
                    "days_in_period": 13,
                    "evaluated_day_count": 1,
                    "closed_day_count": 1,
                    "profit_total_minor": 75000,
                    "avg_profit_minor": 75000,
                    "avg_revenue_per_assigned_minor": 25000,
    ...
    def test_get_day_economics_without_team_keeps_per_employee_metrics_empty(self):
        with (
            ...
            patch("app.services.finance.day_economics._get_kpi_breakdown", return_value=[]),
            patch(
                "app.services.finance.day_economics.get_day_economics_plan",
                return_value={
                    "date": date(2026, 3, 13),
            ...
            patch(
                ...
                return_value={
                    ...
                    "closed_day_count": 0,
                    "profit_total_minor": 0,
                    "avg_profit_minor": None,
                    "avg_revenue_per_assigned_minor": None,
    ...
    def test_get_day_economics_plan_falls_back_to_weekday_template(self):
        ...
        with (
            patch("app.services.finance.day_economics._get_date_override_plan_model", return_value=None),
            patch("app.services.finance.day_economics._get_month_plan_model", return_value=None),
            patch("app.services.finance.day_economics._get_weekday_template_model", return_value=template),
        ):
