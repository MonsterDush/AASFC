...
const pageStyleCacheKeyOverrides = new Map([
  ...
  ["owner-integration-issues.html", "20260910-composite1"],
...
const inlineFreeEntrypoints = new Map([
  ...
  ["owner-integration-issues.html", "/owner-integration-issues.js?v=20260910-composite1"],
  ...
  ["owner-quickresto.html", "/owner-quickresto.js?v=20260910-composite1"],
