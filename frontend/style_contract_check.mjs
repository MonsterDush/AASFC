...
const pageStyleCacheKeyOverrides = new Map([
  ...
  ["owner-dashboard.html", "20260924-owner-dashboard2"],
...
const inlineFreeEntrypoints = new Map([
  ["admin-position-templates.html", "/admin-position-templates.js?v=20260924-dashboardnav1"],
  ["app-adjustments.html", "/app-adjustments.js?v=20260924-dashboardnav1"],
  ["owner-departments.html", "/owner-departments.js?v=20260924-dashboardnav1"],
  ["owner-day-economics.html", "/owner-day-economics.js?v=20260924-dashboardnav1"],
  ["owner-department-plans.html", "/owner-department-plans.js?v=20260924-dashboardnav1"],
  ["owner-dashboard.html", "/owner-dashboard.js?v=20260924-dashboardnav1"],
  ["owner-economics-plans.html", "/owner-economics-plans.js?v=20260924-dashboardnav1"],
  ["owner-economics-rules.html", "/owner-economics-rules.js?v=20260924-dashboardnav1"],
  ["owner-expense-categories.html", "/owner-expense-categories.js?v=20260924-dashboardnav1"],
  ["owner-expenses.html", "/owner-expenses.js?v=20260924-dashboardnav1"],
  ["owner-finance-ledger.html", "/owner-finance-ledger.js?v=20260924-dashboardnav1"],
  ["owner-integration-issues.html", "/owner-integration-issues.js?v=20260924-dashboardnav1"],
  ["owner-integrations.html", "/owner-integrations.js?v=20260924-dashboardnav1"],
  ["owner-kpi.html", "/owner-kpi.js?v=20260924-dashboardnav1"],
  ...
  ["owner-payroll.html", "/owner-payroll.js?v=20260924-dashboardnav1"],
  ["owner-payment-methods.html", "/owner-payment-methods.js?v=20260924-dashboardnav1"],
  ["owner-quickresto.html", "/owner-quickresto.js?v=20260924-dashboardnav1"],
  ["owner-quickresto-import-history.html", "/owner-quickresto-import-history.js?v=20260924-dashboardnav1"],
  ["owner-quickresto-kpi.html", "/owner-quickresto-kpi.js?v=20260924-dashboardnav1"],
  ["owner-recurring-expenses.html", "/owner-recurring-expenses.js?v=20260924-dashboardnav1"],
  ["owner-setup.html", "/owner-setup.js?v=20260924-dashboardnav1"],
  ["owner-summary.html", "/owner-summary.js?v=20260924-dashboardnav1"],
  ["owner-suppliers.html", "/owner-suppliers.js?v=20260924-dashboardnav1"],
  ["owner-turnover.html", "/owner-turnover.js?v=20260924-dashboardnav1"],
  ["shift-intervals.html", "/shift-intervals.js?v=20260924-dashboardnav1"],
  ["shift-schedule-templates.html", "/shift-schedule-templates.js?v=20260924-dashboardnav1"],
...
for (const fileName of htmlPageFiles) {
  ...
  assert.ok(
    source.includes('<script src="/page-loader.js?v=20260823-navfix1"></script>'),
...
for (const [htmlFileName, pageStylePath, contracts] of [
  ...
  ["owner-dashboard.html", "styles/pages/owner-dashboard.css", ["owner-dashboard-widget-grid", "owner-dashboard-actions-grid", "owner-dashboard-config", "owner-dashboard-attention", "owner-dashboard-trend", "owner-dashboard-operations", "owner-dashboard-network"]],
  ...
  ["owner-payroll.html", "styles/pages/owner-payroll.css", ["payroll-period-grid", "payroll-metric--per-shift", "payroll-leaderboard-row", "payroll-payment-rule", "payroll-state--error"]],
  ["owner-turnover.html", "styles/pages/finance-pages.css", ["revenue-trend-chart", "revenue-structure-row", "revenue-trend-focus"]],
...
for (const fileName of unifiedCatalogFiles) {
  ...
  const cacheKey = "20260924-dashboardnav1";
  assert.ok(
